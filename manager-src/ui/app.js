/* ==========================================================================
   V-PreCode Manager UI Logic & State Machine
   Features: Dual Theme Switcher, Unified Toggle Cards, State Locking, Synchronous Updates
   ========================================================================== */
...
// TIP: Theme Manager - Toggles dark/light mode with persistence
function initThemeManager() {
    const savedTheme = localStorage.getItem('vprecode_theme') || 'dark';
    ...
    if (toggleBtn) {
        toggleBtn.addEventListener('click', () => {
            ...
            localStorage.setItem('vprecode_theme', nextTheme);
...
function renderServiceUI(serviceKey) {
    ...
    if (state === 'running') {
        ...
        toggleBtn.className = 'btn-toggle liquid-glass action-stop';
        ...
        toggleBtn.className = 'btn-toggle liquid-glass';
        ...
        toggleBtn.className = 'btn-toggle liquid-glass action-start';
        toggleBtn.disabled = false;
